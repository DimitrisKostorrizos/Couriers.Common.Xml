...
namespace Couriers.Common.Xml
{
    ...
    public static class XmlHelpers
    {
        ...
        /// <summary>
        /// Throws a <see cref="UnreachableException"/> if the specified <paramref name="value"/> is null
        /// </summary>
        /// <typeparam name="T">The type of the object</typeparam>
        /// <param name="value">The value</param>
        /// <exception cref="UnreachableException">An exception if thrown if the <paramref name="value"/> is <see langword="null"/></exception>
        [ExcludeFromCodeCoverage]
        private static void ThrowIfMismatchedXMLType<T>([NotNull] T? value)
        {
            if (value is null)
                throw new UnreachableException($"The XML does not match the type {nameof(T)}");
        }
